...
public interface P5PanelF21 {
    ...
    public static int getWallColor(int distance, int cc, int extensionX) {
		...
		// RGB_DEF = 20
		// RGB_DEF_GREEN = 60		
		// formula is rgb = 65536 * r + 256 * g + b;
		
		switch (((d >> 3) ^ cc) % 6) {
		case 0:
			//rgbValue, RGB_DEF, RGB_DEF
			return 65536 * rgbValue + 256 * 20 + 20;
		case 1:
			//RGB_DEF, RGB_DEF_GREEN, RGB_DEF
			return 65536 * 20 + 256 * 60 + 20;
		case 2:
			//RGB_DEF, RGB_DEF, rgbValue
			return 65536 * 20 + 256 * 20 + rgbValue;
		case 3:
			//rgbValue, RGB_DEF_GREEN, RGB_DEF
			return 65536 * rgbValue + 256 * 60 + 20;
		case 4:
			//RGB_DEF, RGB_DEF_GREEN, rgbValue
			return 65536 * 20 + 256 * 60 + rgbValue;
		case 5:
			//rgbValue, RGB_DEF, rgbValue
			return 65536 * rgbValue + 256 * 20 + rgbValue;
		default:
			//RGB_DEF, RGB_DEF, RGB_DEF
			return 65536 * 20 + 256 * 20 + 20;
